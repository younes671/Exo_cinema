...
<table class="uk-table uk-table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a style='text-decoration:none'class='link-light' href='index.php?action=modifyRealisateur&id=<?= $realisateur['id_realisateur'] ?>'><button class='btn btn-primary btn-sm' type='button'>Modifier Realisateur</button></a></td>
        </tr>
    <?php } ?>
    </tbody>
</table>
