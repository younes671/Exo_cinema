...
<a class="link" style='text-decoration:none'class='link-light' href='index.php?action=addRealisateur&id=<?= $realisateur['id_realisateur'] ?>'><button class='btn btn-success btn-sm' type='button'>Ajouter Realisateur</button></a>
