...
<table class="uk-table uk-table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="index.php?action=detailFilm&id=<?= $film["id_film"] ?>"><?= $film['titre'] . " " . $film['annee_sortie'] ?></a></td>
...
<a class="link" style='text-decoration:none'class='link-light' href='index.php?action=addFilm&id=<?= $film['id_film'] ?>'><button class='btn btn-success btn-sm' type='button'>Ajouter film</button></a>
