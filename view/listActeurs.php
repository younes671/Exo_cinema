...
<table class="uk-table uk-table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a style='text-decoration:none'class='link-light' href='index.php?action=formAddActeur&id=<?= $acteur['id_acteur'] ?>'><button class='btn btn-success btn-sm' type='button'>Ajouter Acteur</button></a></td>
