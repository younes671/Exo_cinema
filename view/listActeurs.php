...
<a class="link" style='text-decoration:none'class='link-light' href='index.php?action=addActeur&id=<?= $acteur['id_acteur'] ?>'><button class='btn btn-success btn-sm' type='button'>Ajouter Acteur</button></a>
